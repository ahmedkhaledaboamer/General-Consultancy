      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            {/* Decorative elements */}
            <div className="absolute -top-6 -right-6 w-32 h-32 bg-teal/10 rounded-full blur-2xl -z-10" />
            <div className="absolute -bottom-6 -left-6 w-40 h-40 bg-gold/20 rounded-full blur-2xl -z-10" />
          </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <motion.div
                ...
                className={`relative p-6 rounded-2xl bg-white shadow-lg shadow-gray-200/50 hover:shadow-xl transition-all duration-300 group overflow-hidden ${index === reasons.length - 1 ? 'sm:col-span-2 lg:col-span-1' : ''}`}>
                  ...
                  <div
                  className={`absolute top-0 right-0 w-1.5 h-full bg-gradient-to-b ${reason.gradient} opacity-70 group-hover:opacity-100 transition-opacity`} />
                

                  <div
                  className={`w-14 h-14 rounded-xl ${reason.bgLight} flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300 shadow-sm`}>
