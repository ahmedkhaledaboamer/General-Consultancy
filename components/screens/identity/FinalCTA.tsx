    ...
    <section className="relative py-32 md:py-48 overflow-hidden">
      ...
      <div className="mx-auto px-[5%] relative z-10 text-center">
        <motion.div
          ...
          <h2 className="text-5xl md:text-7xl lg:text-8xl font-cairo font-bold text-white mb-10 leading-tight drop-shadow-2xl">
            إذا كنت تبحث عن شريك مؤسسي موثوق...
          </h2>

          <p className="text-2xl md:text-4xl text-white/90 leading-relaxed font-tajawal mb-16 drop-shadow-lg font-medium">
