        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 md:w-4/5 lg:w-5/6 xl:w-6/7 2xl:w-7/8 rounded-3xl overflow-hidden shadow-2xl border-4 border-white/10 z-10">
              ...
              <Image
                src="/imgs/A strategic pathway scene with/image_1.webp"
            ...
            <motion.div
              ...
              <Image
                src="/imgs/A strategic planning map envir/image_28.webp"
                alt="Leadership"
                className="w-full h-full object-cover"
                width={800}
                height={800}
            ...
            <motion.div
              ...
              <Image
                src="/imgs/A strategic planning studio en/image_33.webp"
                alt="Partnership"
                className="w-full h-full object-cover"
                width={800}
                height={800}
