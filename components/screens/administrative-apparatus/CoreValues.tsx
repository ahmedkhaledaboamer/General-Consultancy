...
export function CoreValues() {
  return (
    <section
      id="values"
      className="py-32 bg-gradient-to-br from-rose-50 via-purple-50 to-blue-50 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          ...
          <motion.div
            ...
            className="relative h-80 rounded-3xl overflow-hidden shadow-2xl group hover:-translate-y-2 transition-all duration-500">
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end text-white z-10">
              ...
              <h3 className="text-3xl font-bold mb-3">الاحترافية</h3>
          ...
          <motion.div
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end text-white z-10">
              ...
              <h3 className="text-3xl font-bold mb-3">النزاهة</h3>
              <p className="text-white/90 text-lg leading-relaxed">
          ...
          <motion.div
            ...
            className="relative h-80 rounded-3xl overflow-hidden shadow-2xl group hover:-translate-y-2 transition-all duration-500 lg:col-start-2 lg:-ms-1/2">
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end text-white z-10">
              ...
              <h3 className="text-3xl font-bold mb-3">المسؤولية</h3>
              <p className="text-white/90 text-lg leading-relaxed">
          ...
          <motion.div
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end text-white z-10">
              ...
              <h3 className="text-3xl font-bold mb-3">الشراكة</h3>
              <p className="text-white/90 text-lg leading-relaxed">
